...
function check_sketch(){
    ...
    if(timer_counter>=500){
        timer_counter = 0;
        timer_checker = 'compleated'
    }
    if(timer_checker == 'compleated'/answer_holder == 'set'){
        timer_checker = '';
        answer_holder = '';
        updateCanvas()
    }
...
document.getElementById("sketch_dra").innerHTML = "Sketch To be drawn : " + sketch ;
}